                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
                        ...
                        className="touch-target flex items-center justify-center rounded-lg hover:bg-gray-500/10 transition-colors"
                        style={{ color: 'var(--text-tertiary)' }} title="Edit" aria-label="Edit task">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                      </motion.button>
                      <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
                        onClick={() => handleDelete(task._id)}
                        className="touch-target flex items-center justify-center rounded-lg hover:bg-red-500/10 transition-colors text-red-400" title="Delete" aria-label="Delete task">
